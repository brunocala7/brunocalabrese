...
public class AccesoBaseDeDatos {
    ...
    public HashMap<String,Object> obtenerDatos() throws SQLException {
        ...
        try {
            while(resultado.next()){
                String persona = "Persona " + numPersona;
                datos.put(persona,resultado);
            }
    ...
    public void agregarAlumno(Alumno alumno) {
        try{
            Statement sentencia = this.conexion.createStatement();
            String consulta ="INSERT into " + this.nombreTabla + " VALUES (" + alumno.getNombre() + "," + alumno.getEdad() + ")";
            sentencia.executeUpdate(consulta);
            sentencia.close();
        }
        catch (SQLException excepcion){
